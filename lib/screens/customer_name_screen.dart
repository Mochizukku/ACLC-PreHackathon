                ...
                Row(
                  ...
                  children: [
                    TextButton.icon(
                      ...
                      icon: const Icon(Icons.qr_code_scanner_rounded, size: 18, color: AppTheme.primaryOrange),
                      label: const Text(
                        'Rescan Table',
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.table_restaurant_rounded, size: 16, color: AppTheme.primaryGold),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          height: 50,
                          decoration: BoxDecoration(
                            color: isSelected ? AppTheme.primaryOrange.withOpacity(0.25) : AppTheme.cardBg,
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.person_outline_rounded, color: AppTheme.primaryOrange),
                          filled: true,
                        ...
                        validator: (value) {
                          ...
                          // Content filter: block profanity, hate speech & brainrot
